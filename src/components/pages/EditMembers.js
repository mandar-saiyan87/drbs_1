      ...
      <form onSubmit={() => handleEdits(eMember, eMember.id)}>
        <div className='px-9'>
          ...
          <div className="my-9">
            ...
            <select required value={eMember.paymentmode} onChange={handleUpdate} name="paymentmode">
              <option disabled>Select</option>
          ...
          <div className="my-9">
            ...
            <div className='grid grid-cols-3 gap-4'>
              <div className='flex flex-col my-2'>
                ...
                <input required type="date" name="dob" value={eMember.dob} className="w-[60%]" onChange={handleUpdate} />
              </div>
              <div className='flex flex-col my-2'>
              ...
              <div className='flex flex-col my-2'>
                ...
                <input required type="text" name="mobile" value={eMember.mobile} maxLength="10" className="w-[70%]" onChange={handleUpdate} />
              </div>
              <div className='flex flex-col my-2'>
                <label className="mr-3" for="bloodgroup">रक्तगट</label>
                <input required type="text" name="bloodgroup" value={eMember.bloodgroup} className='w-[20%]' maxLength="5" onChange={handleUpdate} />
              </div>
              <div className='flex flex-col my-2'>
                <label className="mr-3" for="education">शिक्षण</label>
                <input required type="text" name="education" value={eMember.education} maxLength="100" className="w-[70%]" onChange={handleUpdate} />
              </div>
              <div className='flex flex-col my-2'>
                <label className="mr-3" for="gotra">गोत्र</label>
                <input required type="text" name="gotra" value={eMember.gotra} maxLength="100" className="w-[70%]" onChange={handleUpdate} />
              </div>
              <div className='flex flex-col my-2'>
                <label className="mr-3" for="occupation">नौकरी/व्यवसाय</label>
                <input required type="text" name="occupation" value={eMember.occupation} maxLength="200" className="w-[70%]" onChange={handleUpdate} />
              </div>
              <div className='flex flex-col my-2'>
              ...
              <div className='flex flex-col my-2'>
                ...
                <select required value={eMember.livingStatus} onChange={handleUpdate} name="livingStatus">
                  <option disabled>Select</option>
