    ...
    <>
      <div className='px-9'>
        <div className='my-9'>
          ...
          <div >
            <select value={eMember.membership} onChange={() => { }} name="membership" disabled>
        ...
        <div className="my-9">
          ...
          <select value={eMember.paymentmode} onChange={() => { }} name="paymentmode" disabled>
            <option selected>Select</option>
          ...
          <div className="my-9">
            ...
            <div className='grid grid-cols-3 gap-4'>
              <div className='flex flex-col my-2'>
                ...
                <input type="text" name="checkno" value={eMember.checkno} className='w-[60%]' maxLength="10" onChange={() => { }} disabled />
              </div>
              <div className='flex flex-col my-2'>
                <label className="mr-3" for="paymentmode1">दिनांक</label>
                <input type="date" name="date" value={eMember.checkdate} className='w-[65%]' onChange={() => { }} disabled />
              </div>
              <div className='flex flex-col my-2'>
                <label className="mr-3" for="bank">बँक</label>
                <input type="text" name="bankname" value={eMember.bankname} className='w-[60%]' onChange={() => { }} disabled />
              </div>
            </div>
          </div>
        </> : null}
        <div className="my-9">
          ...
          <div className='grid grid-cols-3 gap-4'>
            ...
            <div className='flex flex-col my-2'>
              ...
              <input type="text" name="mobile" value={eMember.mobile} maxLength="15" className="w-[70%]" onChange={handleUpdate} />
            </div>
            <div className='flex flex-col my-2'>
        ...
        {/* </form> */}
        <button type="submit" className="submitbtn" onClick={() => handleEdits(eMember, eMember.id)}>Update</button>
      </div>
