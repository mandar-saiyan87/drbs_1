    ...
    <>
      <div className='px-9'>
        <div className='my-9'>
          ...
          <div >
            <select value={booking.event} onChange={handleChange} name="event">
        ...
        <div className='flex flex-col my-2'>
          ...
          <textarea name="description" value={booking.description} className='w-[40%]' rows="4" col="50" onChange={handleChange} />
        </div>
        <div className='flex flex-row my-5'>
          <div className='flex flex-col mr-20'>
            <label className="mr-3" for="fullname">अर्जदाराचे नाव</label>
            <input type="text" name="fullname" value={booking.fullname} className='w-[100%]' maxLength="100" onChange={handleChange} />
          </div>
          <div className='flex flex-col'>
            <label className="mr-3" for="address">पत्ता</label>
            <textarea type="text" name="address" value={booking.address} className="w-[100%]" maxLength="500" onChange={handleChange} />
          </div>
        </div>
        ...
        <div className='flex flex-row my-5'>
          ...
          <div>
            ...
            <div>
              <select value={booking.membership} onChange={handleChange} name="membership">
                <option selected>Select</option>
        ...
        <div className='flex flex-row my-10 justify-between w-[90%]'>
          <div className='flex flex-col w-[10%]'>
            ...
            <select value={booking.bookingtype} onChange={handleChange} name="bookingtype">
              <option selected>Select</option>
          ...
          <div className='flex flex-col w-[20%]'>
            ...
            <input type="date" name="eventdate" value={booking.eventdate} className="w-[95%]" onChange={handleChange} />
          </div>
          <div className='flex flex-col'>
            <label className="text-[1.2rem]" for="landline">निमंत्रितांची अंदाजे संख्या</label>
            <input type="text" name="guestno" value={booking.guestno} maxLength="10" className="w-[30%]" onChange={handleChange} />
          </div>
          <div className='flex flex-col w-[10%]'>
            <label className='text-[1.2rem]'>सभागृह</label>
            <select value={booking.hallno} onChange={handleChange} name="hallno">
              <option selected>Select</option>
        ...
        <div className='flex flex-row my-10 justify-between w-[80%]'>
          <div className='flex flex-col w-[10%]'>
            ...
            <input type="text" name="rent" value={booking.rent} onChange={handleChange} />
          </div>
          <div className='flex flex-col w-[10%]'>
            <label className="text-[1.2rem]">अनामत रुपये</label>
            <input type="text" name="deposit" value={booking.deposit} onChange={handleChange} />
          </div>
          <div className='flex flex-col w-[10%]'>
            <label className="text-[1.2rem]">एकूण</label>
            <input type="text" name="total" value={`${booking.rent + booking.deposit}`} onChange={handleChange} />
          </div>
        ...
        <div className="my-10">
          ...
          <div className='grid grid-cols-4'>
            ...
            <div className='flex flex-col my-2'>
              ...
              <input type="text" name="totalamount" value={booking.total} className='w-[60%]' onChange={handleChange} />
            </div>
          </div>
        </div>
        <div className='flex flex-row my-10 justify-between w-[80%]'>
        ...
        <button type="submit" className="submitbtn" onClick={() => { }}>Submit</button>
        <div className="my-10">
