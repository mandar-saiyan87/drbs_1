            ...
            <div className="my-10">
              ...
              <div className='grid grid-cols-4'>
                <div className='flex flex-col my-2'>
                  ...
                  <input required type="text" name="checkno" value={eBooking.checkno} className='w-[60%]' maxLength="10" onChange={handleUpdate} />
                </div>
                <div className='flex flex-col my-2'>
                  <label className="mr-3">दिनांक</label>
                  <input required type="date" name="checkdate" value={eBooking.checkdate} className='w-[65%]' onChange={handleUpdate} />
                </div>
                <div className='flex flex-col my-2'>
                  <label className="mr-3" for="bank">बँक</label>
                  <input required type="text" name="bankname" value={eBooking.bankname} className='w-[60%]' onChange={handleUpdate} />
                </div>
                <div className='flex flex-col my-2'>
