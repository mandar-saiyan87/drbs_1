      ...
      <form onSubmit={handleSubmit}>
        <div className='px-9'>
          ...
          <div className="my-9">
            ...
            <select required value={memberDetails.paymentmode} onChange={handleChange} name="paymentmode" >
              <option disabled>Select</option>
          ...
          <div className="my-9">
            ...
            <div className='grid grid-cols-3 gap-4'>
              ...
              <div className='flex flex-col my-2'>
                ...
                <input required type="text" name="mobile" value={memberDetails.mobile} maxLength="10" className="w-[70%]" onChange={handleChange} />
              </div>
              <div className='flex flex-col my-2'>
                <label className="mr-3" for="bloodgroup">रक्तगट</label>
                <input required type="text" name="bloodgroup" value={memberDetails.bloodgroup} className='w-[20%]' maxLength="5" onChange={handleChange} />
              </div>
              <div className='flex flex-col my-2'>
