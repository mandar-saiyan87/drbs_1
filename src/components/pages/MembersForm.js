          ...
          <div className="my-9">
            ...
            <div className='grid grid-cols-3 gap-4'>
              ...
              <div className='flex flex-col my-2'>
                ...
                <input type="date" name="date" value={memberDetails.checkdate} className='w-[65%]' onChange={handleChange} />
              </div>
              <div className='flex flex-col my-2'>
        ...
        <div className="my-9">
          ...
          <div className='grid grid-cols-3 gap-4'>
            ...
            <div className='flex flex-col my-2'>
              ...
              <input type="text" name="mobile" value={memberDetails.mobile} maxLength="15" className="w-[70%]" onChange={handleChange} />
            </div>
            <div className='flex flex-col my-2'>
